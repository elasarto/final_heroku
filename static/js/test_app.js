...
// group element to nest bottom axes labels.
...
xText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "positve")
  .attr("data-axis", "x")
  .attr("class", "aText active x")
  .text("Positve Sentiment Score");
// 2. negative
xText
  .append("text")
  .attr("y", 0)
  .attr("data-name", "negative")
  .attr("data-axis", "x")
...
d3.csv("/static/band_analysis.csv", function(data) {
  // Visualize the data
  visualize(data);
});
...
function visualize(theData) {
      ...
      if (axis === "x") {
        ...
        d3.selectAll(".stateText").each(function() {
          ...
          d3
            ...
            .transition()
            .attr("dy", function(d) {
              return yScale(d[xValue]) + getRadius;
            })
            .duration(300);
        });
  ...
  function resize() {
    ...
    // change location of circle styles
    d3
      .selectAll("circle")
      .attr("cy", function(d) {
        return yScale(d[yValue]);
    ...
    // change location of circle text
    d3
      .selectAll(".stateText")
      .attr("dy", function(d) {
